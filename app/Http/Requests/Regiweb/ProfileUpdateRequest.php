...
class ProfileUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'genero' => ['required', Rule::in(GenderEnum::cases())],
            ...
            're_e' => ['required', Rule::in(YesNoEnum::cases())],
            ...
            'lp1' => ['nullable', Rule::in(YesNoEnum::cases())],
            'lp2' => ['nullable', Rule::in(YesNoEnum::cases())],
            'lp3' => ['nullable', Rule::in(YesNoEnum::cases())],
            'lp4' => ['nullable', Rule::in(YesNoEnum::cases())],
            'fex1' => ['nullable', 'date'],
            'fex2' => ['nullable', 'date'],
            'fex3' => ['nullable', 'date'],
            'fex4' => ['nullable', 'date'],
